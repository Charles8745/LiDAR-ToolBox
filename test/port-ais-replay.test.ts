...
import { lerpAngleDeg, positionAt, vesselsInPortAt } from '../examples/kaohsiung-port/time/ais-replay';
...
describe('vesselsInPortAt', () => {
  const inside = track([[22.60, 120.30, 0, 0], [22.60, 120.30, 200_000, 0]]); inside.mmsi = 'A';
  const arriving = track([[22.60, 120.10, 0, 90], [22.60, 120.30, 120_000, 90]]); arriving.mmsi = 'B'; // 偏西→進港
